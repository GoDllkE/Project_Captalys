...
<?php if (isset($_SESSION["statusLogin"]) && $_SESSION["statusLogin"] == 1) { ?>
    ...
    <br />
    <div>
        <a class="btn btn-outline-danger" style="width: 15%;" href="../../Controllers/usuarioLogoff.php">Fazer LogOff</a>
        <a class="btn btn-outline-primary" style="width: 15%;" href="_Layout.php?CodPg=5">Voltar a Home</a>
    </div>
<?php } else { ?>
