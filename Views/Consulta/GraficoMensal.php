<?php
    ...
    // $dados = $objConsulta->geraValoresMediaMes();
    
    // Define array de dados a ser utilizado
    
    $dados = array(
        array('Janeiro', '10230'), 
        array('Fevereiro', '12334'),
        array('Marco', '12334'),
        array('Abril', '11345'),
        array('Maio', '8902'),
        array('Junho', '10230'),
        array('Julho', '10230'),
        array('Agosto', '10230'),
        array('Setembro', '10230'),
        array('Outubro', '10230'),
        array('Novembro', '10230'),
        array('Dezembro', '10230'),
    );
    ...
    $titulo = utf8_decode('Valor médio em relação ao mes');
